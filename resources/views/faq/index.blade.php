...
@section('content_header')
    <h1 class="m-0 text-dark">Manajemen Faq</h1>
@stop
...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <a href="/faq/create" class="btn btn-primary mb-2">Tambah Faq</a>
                ...
                success(data){
                    ...
                    const d = data.map((value,key) => {
                        return `<tr>
                            ...
                            <td>${value.answer}</td>
                            <td>
                                <a href="/faq/${value.id}/edit" class="btn btn-warning btn-sm"><i class="fa fa-pencil-alt"></i></a>
