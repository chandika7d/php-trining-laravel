...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <a href="/banks/create" class="btn btn-primary mb-2">Tambah Bank</a>
                ...
                success(data){
                    ...
                    const d = data.map((value,key) => {
                        return `<tr>
                            <th scope="row">${++key}</th>
                            <td>${value.bank}</td>
                            <td>${value.image != '' ? `<img class="w-100 h-100" src="${value.image}">` : '-'}</td>
                            <td>
                                <a href="/banks/${value.id}/edit" class="btn btn-warning btn-sm"><i class="fa fa-pencil-alt"></i></a>
