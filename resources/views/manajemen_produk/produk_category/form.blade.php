...
@section('content_header')
    <h1 class="m-0 text-dark">Form {{isset($id) ? 'Edit' : 'Tambah'}} Produk Category</h1>
@stop
...
@section('content')
    <div class="row">
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    <form action="{{isset($id) ? '/api/produk_category/'.$id : '/api/produk_category'}}" method="post" id="form" enctype="multipart/form-data">
                        @if(isset($id))
                            @method('put')
                        @else
                            @method('post')
                        ...
                        <div class="form-group">
                            <label for="name">Produk Category</label>
        ...
        function submitApi(){
            ...
            $.ajax({
                ...
                success(data){
                    ...
                    setTimeout(() => {
                        window.location.href = '/produk_category';
                    }, 500);
                },
                error(error){
                    $('#btn-submit').removeAttr('disabled');
