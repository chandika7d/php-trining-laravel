...
@section('content_header')
    <h1 class="m-0 text-dark">Form {{isset($id) ? 'Edit' : 'Tambah'}} Brands</h1>
@stop
...
@section('content')
    <div class="row">
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    <form action="{{isset($id) ? '/api/brands/'.$id : '/api/brands'}}" method="post" id="form" enctype="multipart/form-data">
                        @if(isset($id))
                            @method('put')
                        @else
                            @method('post')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="slug" class="form-control" id="slug" placeholder="silahkan isi..">
                        ...
                        <div class="form-group">
                            ...
                            <img src="" id="img_photo" class="mb-3 w-50 h-50 img-thumbnail d-none">

                            <input type="file" name="photo" class="form-control" id="photo" onchange="validateInputFileImage(this)">
                        ...
                        <div class="form-group">
                            <label for="secondary_photo">Secondary Photo</label>

                            <img src="" id="img_secondary_photo" class="mb-3 img-thumbnail d-none" style="width: 200px; height: 200px;">

                            <input type="file" name="secondary_photo" class="form-control" id="secondary_photo" onchange="validateInputFileImage(this)">
                            <small> * File Upload yang diperbolehkan berektensi JPG,JPEG,PNG,webp</small><br>
                            <small> * Maksimal Upload 2MB</small><br>
                            <span class="text-danger" id="secondary_photo_error"></span>
                        </div>
                        <div class="form-group">
    ...
    <script>
        ...
        function getDetail(){
            $.ajax({
                ...
                success(data){
                    for(const d in data){
                        if(d != 'created_at' && d != 'updated_at' && d !='photo' && d !='secondary_photo'){
                            $('#'+d).val(data[d]);
                        }

                        if(d == 'photo' || d == 'secondary_photo'){
