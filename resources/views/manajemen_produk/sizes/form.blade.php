...
@section('content_header')
    <h1 class="m-0 text-dark">Form {{isset($id) ? 'Edit' : 'Tambah'}} Size</h1>
@stop
...
@section('content')
    <div class="row">
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    <form action="{{isset($id) ? '/api/sizes/'.$id : '/api/sizes'}}" method="post" id="form" enctype="multipart/form-data">
                        @if(isset($id))
                            @method('put')
                        @else
                            @method('post')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" onkeyup='validateNumber(this)' name="order" class="form-control" id="order" placeholder="silahkan isi..">
                                <span class="text-danger" id="order_error"></span>
                        </div>
                        <div class="form-group">
